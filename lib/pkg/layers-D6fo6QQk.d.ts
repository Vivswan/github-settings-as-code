...
declare const INPUT_DECLS: {
  ...
  readonly visibility: {
    readonly description: 'Keeps only repositories of this visibility in repos: "*" discovery. One of all (default), public, private, or internal; internal is matched client-side (Enterprise only). Fails if set outside that discovery.';
    readonly default: "";
  };
  readonly archived: {
    readonly description: 'Archived-repository policy for repos: "*" discovery. One of skip (default; settings writes fail on archived repositories), include, or only (mostly useful with mode: check). Fails if set outside that discovery.';
    readonly default: "";
  };
  readonly forks: {
    readonly description: 'Fork policy for repos: "*" discovery. One of include (default), exclude, or only. Fails if set outside that discovery.';
    readonly default: "";
  };
  readonly exclude: {
    readonly description: string;
  ...
  readonly topics: {
    readonly description: 'Comma- or newline-separated topics; repos: "*" discovery keeps only repositories carrying at least one of them. Unrelated to the topics settings section. Fails if set outside that discovery.';
    readonly default: "";
    readonly list: true;
  };
