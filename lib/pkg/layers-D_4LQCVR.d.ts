 ...
 */
declare const DOCUMENT_DIRECTIVE_KEYS: readonly ["_layering"];
//#endregion
...
type SettingsProblem = ProblemOf<"settings-not-mapping" | "settings-not-plain-mapping" | "settings-unknown-sections" | "settings-unknown-directives" | "settings-malformed-sections">;
/**
...
interface GitHubClient {
   ...
   */
  tryGraphql(op: GraphqlOp, variables: Readonly<Record<string, unknown>>, slug: string, options?: RequestMark): Promise<{
 ...
 */
declare function stripNulls(doc: unknown): unknown;
...
declare function describeOptOut(notice: OptOutNotice): string;
declare function mergeLayers(layers: readonly Layer[], options: {
 ...
 */
type SectionModule<K extends SectionKey = SectionKey, E extends EndpointDict = EndpointDict, G extends GraphqlDict = GraphqlDict> = SectionModuleBase<K, E, G> & SnapshotFacet<K, E, G> & {
...
interface BoundRead<E extends EndpointDecl> {
  ...
  tryCall<T>(schema: z.ZodType<T>, ...args: TryCallOpts<E>): Promise<{
    data: T;
  } | {
    error: ApiError;
  }>;
  probeAbsent<T>(schema: z.ZodType<T>, ...args: ProbeOpts<E>): Promise<{
    data: T;
  } | {
    missing: true;
  }>;
...
interface GatedBoundRead<E extends EndpointDecl> {
  ...
  tryCall<T>(exec: ExecTools, schema: z.ZodType<T>, ...args: TryCallOpts<E>): Promise<{
    data: T;
  } | {
    error: ApiError;
  }>;
  probeAbsent<T>(exec: ExecTools, schema: z.ZodType<T>, ...args: ProbeOpts<E>): Promise<{
    data: T;
  } | {
    missing: true;
  }>;
  listAll<T>(exec: ExecTools, item: z.ZodType<T>, ...args: ListOpts<E>): Promise<T[]>;
  listAllEnveloped<T>(exec: ExecTools, envelopeKey: string, item: z.ZodType<T>, ...args: ListOpts<E>): Promise<T[]>;
}
...
type BoundGraphqlRead<O extends GraphqlOpDecl> = {
  ...
  tryCall<T>(schema: z.ZodType<T>, variables: Readonly<GraphqlVariablesOf<O>>, opts?: GraphqlTryOpts<O>): Promise<{
    data: T;
  } | {
    error: ApiError;
  }>;
...
type GatedBoundGraphqlRead<O extends GraphqlOpDecl> = {
  ...
  tryCall<T>(exec: ExecTools, schema: z.ZodType<T>, variables: Readonly<GraphqlVariablesOf<O>>, opts?: GraphqlTryOpts<O>): Promise<{
    data: T;
  } | {
    error: ApiError;
  }>;
...
interface ListSectionModule<K extends ListSectionKey, Ends extends ListEndpoints, Live extends object, F extends string, Key extends string, M extends string = never> {
  ...
  readonly plan: (ctx: PlanContext<Ends, GraphqlDict, K>, desired: Declared<K>) => Promise<SectionPlan<PlannedOp<Ends>>>;
 ...
 */
type RepoSecretsPlan<K extends RepoSecretsKey> = { [F in RepoSecretsKey]: (ctx: PlanContext<RepoSecretsEndpoints<SecretsSegment<F>>, GraphqlDict, F>, declared: RepoSecretsDeclared<F>) => Promise<SectionPlan<PlannedOp<RepoSecretsEndpoints<SecretsSegment<F>>>>>; }[K];
/**
...
interface RepoSecretsSectionModule<K extends RepoSecretsKey> {
  ...
  readonly snapshot: (ctx: SnapshotContext<RepoSecretsEndpoints<SecretsSegment<K>>, GraphqlDict, K>) => Promise<SectionSnapshot<K>>;
}
//#endregion
 ...
 */
type SetupPlan<K extends SetupKey> = { [F in SetupKey]: (ctx: PlanContext<SetupEndpoints<F>, GraphqlDict, F>, declared: SetupDeclared<F>) => Promise<SectionPlan<PlannedOp<SetupEndpoints<F>>>>; }[K];
...
interface SetupSectionModule<K extends SetupKey> {
  ...
  readonly snapshot: (ctx: SnapshotContext<SetupEndpoints<K>, GraphqlDict, K>) => Promise<SectionSnapshot<K>>;
}
//#endregion
 ...
 * assign its one SharedPlan to it.
 */
type RepoVariablesPlan<K extends RepoVariablesKey> = { [F in RepoVariablesKey]: (ctx: PlanContext<RepoVariablesEndpoints<VariablesSegment<F>>, GraphqlDict, F>, declared: RepoVariablesDeclared<F>) => Promise<SectionPlan<PlannedOp<RepoVariablesEndpoints<VariablesSegment<F>>>>>; }[K];
...
interface RepoVariablesSectionModule<K extends RepoVariablesKey> {
  ...
  readonly snapshot: (ctx: SnapshotContext<RepoVariablesEndpoints<VariablesSegment<K>>, GraphqlDict, K>) => Promise<SectionSnapshot<K>>;
}
//#endregion
...
declare const byKey: {
  ...
  actions: {
    ...
    }, Readonly<Record<string, GraphqlOpDecl>>, "actions">): Promise<{
      value: ActionsConfig;
      notes: string[];
    }>;
  };
  ...
  workflows: {
    ...
    }, Readonly<Record<string, GraphqlOpDecl>>, "workflows">): Promise<{
      value: undefined;
      notes: never[];
    } | {
      value: {
  ...
  pages: {
    ...
    }, Readonly<Record<string, GraphqlOpDecl>>, "pages">): Promise<{
      value: undefined;
      notes: never[];
    } | {
      value: {
  ...
  collaborators: {
    ...
    }, Readonly<Record<string, GraphqlOpDecl>>, "collaborators">): Promise<{
      value: undefined;
      notes: string[];
    } | {
  ...
  teams: {
    ...
    }, Readonly<Record<string, GraphqlOpDecl>>, "teams">): Promise<{
      value: UndeclaredPolicyList<{
        name: string;
        permission?: string | undefined;
      }> | undefined;
  ...
  interaction_limits: {
    ...
    }, Readonly<Record<string, GraphqlOpDecl>>, "interaction_limits">): Promise<{
      value: undefined;
      notes: string[];
    } | {
      value: {
  ...
  custom_properties: {
    ...
    }, Readonly<Record<string, GraphqlOpDecl>>, "custom_properties">): Promise<{
      value: undefined;
      notes: never[];
    } | {
      value: UndeclaredPolicyList<{
  ...
  secret_scanning_custom_patterns: {
    ...
    }, Readonly<Record<string, GraphqlOpDecl>>, "secret_scanning_custom_patterns">): Promise<{
      value: undefined;
      notes: never[];
    } | {
      value: UndeclaredPolicyList<{
 ...
 */
declare function validateSettingsDoc(settings: unknown, sourceLabel: string, sections: SectionSelection, io: Io): Result<ValidatedSettings, SettingsProblem>;
 ...
 */
declare const RUN_RESULTS: readonly ["failed", "drift", "partial", "skipped", "applied", "clean", "snapshot", "merged"];
...
declare function concludeMerge(io: Io, run: FinishedMerge): number;
//#endregion
...
declare function runMerge(cfg: MergeConfig, io: Io): Result<FinishedMerge, Problem>;
//#endregion
...
declare const MODES: readonly ["apply", "check", "merge", "snapshot"];
 ...
 */
declare const MERGE_ONLY_INPUTS: readonly ["merged-file", "layering"];
 ...
 */
declare const MERGE_INPUTS: readonly ["mode", "settings-file", "merged-file", "layering", "token"];
/**
 ...
 */
declare const MERGE_REJECTED_INPUTS: readonly InputName[];
/**
 ...
 */
declare function snapshotFileDestination(read: InputReader, destination: "settings-file"): string;
/**
 ...
 * be the dir form.
 */
declare function parseSnapshotFileConfig(read: InputReader, env: ConfigEnv, destination: "settings-file"): Result<SnapshotFileConfig, Problem>;
/**
 ...
 */
declare function foldLayers(layers: readonly Layer[], sourceLabel: string, layering: Layering, io: Io): Result<FoldedLayers, SettingsProblem | LayerProblem>;
//#endregion
export { toPublicView as $, LayerProblem as $n, MustBeNever as $t, SingleConfig as A, RequestMark as An, allEndpoints as At, runMerge as B, OutputName as Bn, Tolerance as Bt, parseSnapshotFileConfig as C, discoverRepos as Cn, preflightProbe as Ct, SnapshotConfig as D, GitHubApiOptions as Dn, SectionSelection as Dt, SNAPSHOT_SCHEMA_URL as E, GitHubApi as En, validateSettingsDoc as Et, ResolvedTargets as F, isRateLimitError as Fn, OnMissingPermission as Ft, failRun as G, silentIo as Gn, SectionMeta as Gt, RunFlowConfig as H, maskRegistry as Hn, planContext as Ht, TargetsConfig as I, AnnotationLevel as In, PlanContext as It, PublicTargetView as J, RepoRef as Jn, denialPosture as Jt, PRIVATE_REPOS_POLICIES as K, CentralTarget as Kn, SectionModule as Kt, resolveTargets as L, CollectedLine as Ln, PlannedOpBase as Lt, runSingle as M, SECRET_TRANSPORT_WITHHELD as Mn, sectionModule as Mt, DEFAULT_SETTINGS_FILE as N, TraceIo as Nn, DenialPolicy as Nt, concludeSnapshot as O, GitHubClient as On, SECTIONS as Ot, MultiConfig as P, isPermissionError as Pn, Justification as Pt, publicDetail as Q, CentralFileProblem as Qn, writeGatedReads as Qt, runMulti as R, Io as Rn, SectionPlan as Rt, parseConfig as S, VISIBILITY_FILTERS as Sn, ValidatedSettings as St, FinishedSnapshot as T, DEFAULT_API_VERSION as Tn, skippedSectionKeys as Tt, concludeMerge as U, prefixedIo as Un, snapshotContext as Ut, FinishedMerge as V, collectingIo as Vn, Unverifiable as Vt, concludeRun as W, redactRanges as Wn, KeyedListLayering as Wt, capturingIo as X, dedupeTargets as Xn, sectionGrant as Xt, TargetOutcome as Y, Target as Yn, readGating as Yt, planRedaction as Z, parseRepoSlug as Zn, sectionOperations as Zt, RunConfig as _, ARCHIVED_FILTERS as _n, worstOf as _t, DEFAULT_PRIVATE_REPOS as a, endpointMethod as an, TopLevelShape as ar, deliverArtifactReport as at, SNAPSHOT_REJECTED_INPUTS as b, DiscoveryProblem as bn, RepoRunResult as bt, InputDecl as c, SectionPermission as cn, DOCUMENT_DIRECTIVE_KEYS as cr, RepoVisibility as ct, MERGE_INPUTS as d, Layering as dn, SectionKey as dr, SectionSnapshotOutcome as dt, UndeclaredPolicy as en, Problem as er, PRIVATE_REPORT_CHANNELS as et, MERGE_ONLY_INPUTS as f, OptOutNotice as fn, SettingsFile as fr, SnapshotResult as ft, RunCapabilities as g, AFFILIATIONS as gn, RunOutcome as gt, Mode as h, stripNulls as hn, RUN_RESULTS as ht, ConfigEnv as i, Route as in, SettingsProblem as ir, ArtifactUploader as it, SingleOutcome as j, SECRET_RESPONSE_WITHHELD as jn, allGraphqlOps as jt, runSnapshot as k, GraphqlOp as kn, TaggedEndpoint as kt, InputName as l, grantFor as ln, PROBOT_PARITY_KEYS as lr, createVisibilityResolver as lt, MODES as m, mergeLayers as mn, UndeclaredPolicySection as mr, renderSnapshotYaml as mt, foldLayers as n, GraphqlOpDecl as nn, RERUN_ADVICE as nr, applyMarkerInjection as nt, FILTER_INPUTS as o, endpointPath as on, describeProblem as or, encryptReport as ot, MERGE_REJECTED_INPUTS as p, describeOptOut as pn, UNDECLARED_POLICY_SECTIONS as pr, SnapshotRunOptions as pt, PrivateReposPolicy as q, RemoteTarget as qn, SectionSnapshot as qt, readLayerFiles as r, EndpointDecl as rn, SettingsFileRole as rr, openReportChannel as rt, INPUT_DECLS as s, PatResource as sn, quoteList as sr, parseRecipient as st, FoldedLayers as t, UndeclaredPolicyList as tn, ProblemOf as tr, PrivateReportChannel as tt, InputReader as u, Layer as un, SECTION_KEYS as ur, RenderableSnapshot as ut, SNAPSHOT_INPUTS as v, DEFAULT_DISCOVERY_FILTERS as vn, RepoResult as vt, snapshotFileDestination as w, ApiError as wn, runForRepo as wt, SnapshotFileConfig as x, FORKS_FILTERS as xn, SectionOutcome as xt, SNAPSHOT_ONLY_INPUTS as y, DiscoveryFilters as yn, RepoRunOptions as yt, MergeConfig as z, MaskPair as zn, SnapshotContext as zt };