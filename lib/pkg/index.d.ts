import { $n as LayerProblem, A as SingleConfig, An as RequestMark, At as allEndpoints, B as runMerge, Bn as OutputName, Cn as discoverRepos, D as SnapshotConfig, Dn as GitHubApiOptions, Dt as SectionSelection, En as GitHubApi, Fn as isRateLimitError, Ft as OnMissingPermission, G as failRun, Gn as silentIo, Hn as maskRegistry, Ht as planContext, In as AnnotationLevel, It as PlanContext, Jn as RepoRef, Kn as CentralTarget, Kt as SectionModule, Ln as CollectedLine, M as runSingle, Mt as sectionModule, Nt as DenialPolicy, O as concludeSnapshot, On as GitHubClient, Ot as SECTIONS, P as MultiConfig, Pn as isPermissionError, R as runMulti, Rn as Io, Rt as SectionPlan, S as parseConfig, St as ValidatedSettings, T as FinishedSnapshot, Tn as DEFAULT_API_VERSION, U as concludeMerge, Un as prefixedIo, Ut as snapshotContext, V as FinishedMerge, Vn as collectingIo, W as concludeRun, Wn as redactRanges, Xn as dedupeTargets, Xt as sectionGrant, Y as TargetOutcome, Yn as Target, Zn as parseRepoSlug, _ as RunConfig, _t as worstOf, an as endpointMethod, at as deliverArtifactReport, bt as RepoRunResult, dn as Layering, dr as SectionKey, dt as SectionSnapshotOutcome, er as Problem, fn as OptOutNotice, fr as SettingsFile, ft as SnapshotResult, g as RunCapabilities, gt as RunOutcome, ht as RUN_RESULTS, i as ConfigEnv, in as Route, ir as SettingsProblem, it as ArtifactUploader, j as SingleOutcome, jt as allGraphqlOps, k as runSnapshot, kn as GraphqlOp, kt as TaggedEndpoint, mr as UndeclaredPolicySection, nn as GraphqlOpDecl, on as endpointPath, or as describeProblem, ot as encryptReport, pn as describeOptOut, pr as UNDECLARED_POLICY_SECTIONS, qn as RemoteTarget, qt as SectionSnapshot, r as readLayerFiles, rn as EndpointDecl, rr as SettingsFileRole, rt as openReportChannel, st as parseRecipient, tr as ProblemOf, tt as PrivateReportChannel, u as InputReader, un as Layer, ur as SECTION_KEYS, ut as RenderableSnapshot, vn as DEFAULT_DISCOVERY_FILTERS, wn as ApiError, xt as SectionOutcome, yn as DiscoveryFilters, yt as RepoRunOptions, z as MergeConfig, zn as MaskPair, zt as SnapshotContext } from "./layers-D_4LQCVR.js";
...
//#endregion
export { type AnnotationLevel, type ApiError, type ApplyOptions, type ApplyReport, type ArtifactUploader, type CentralTarget, type CheckOptions, type CheckReport, type CollectedLine, type ConfigEnv, DEFAULT_API_VERSION, DEFAULT_DISCOVERY_FILTERS, type DenialPolicy, type DiscoveryFilters, type EndpointDecl, type FinishedMerge, type FinishedSnapshot, GitHubApi, type GitHubApiOptions, type GitHubClient, type GraphqlOp, type GraphqlOpDecl, type InputReader, type Io, type Layer, type Layering, type MaskPair, type MergeConfig, type MergeOptions, type MergeReport, type MultiConfig, type OnMissingPermission, type OptOutNotice, type OutputName, type PlanContext, type PrivateReportChannel, type Problem, RUN_RESULTS, type RemoteTarget, type RepoRef, type ReportInput, type RequestMark, type Route, type RunCapabilities, type RunConfig, type RunDeps, type RunEnd, type RunOutcome, SECTIONS, SECTION_KEYS, type SectionKey, type SectionModule, type SectionOutcome, type SectionPlan, SectionSelection, type SectionSnapshot, type SectionSnapshotOutcome, SettingsFile, type SettingsFileRole, type SingleConfig, type SingleOutcome, type SnapshotConfig, type SnapshotContext, type SnapshotOptions, type SnapshotReport, type TaggedEndpoint, type Target, type TargetOutcome, UNDECLARED_POLICY_SECTIONS, type UndeclaredPolicySection, type ValidateOptions, type ValidateReport, type ValidatedSettings, allEndpoints, allGraphqlOps, collectingIo, concludeMerge, concludeRun, concludeSnapshot, dedupeTargets, deliverArtifactReport, describeOptOut, describeProblem, discoverRepos, encryptReport, endpointMethod, endpointPath, failRun, isPermissionError, isRateLimitError, maskRegistry, openReportChannel, parseConfig, parseRecipient, parseRepoSlug, planContext, prefixedIo, readLayerFiles, redactRanges, runMerge, runMulti, runSingle, runSnapshot, sectionGrant, sectionModule, silentIo, snapshotContext, worstOf };