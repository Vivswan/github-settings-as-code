#!/usr/bin/env node
import { A as readSettingsFile, C as SNAPSHOT_ONLY_INPUTS, F as concludeRun, H as PRIVATE_REPORT_CHANNELS, I as failRun, Lt as GithubApi, O as runMulti, P as concludeMerge, S as SNAPSHOT_INPUTS, T as parseConfig, Ut as redactRanges, Vt as maskRegistry, _ as INPUT_DECLS, d as runSnapshot, et as describeProblem, f as runSingle, ft as SECTIONS, s as validateSettings, t as runMerge, u as concludeSnapshot, v as MERGE_INPUTS, vt as sectionGrant, y as MERGE_ONLY_INPUTS } from "./src-ECr0efWD.js";
...
async function runConfig(cfg, io, host) {
	...
	if (cfg.kind === "snapshot") return runSnapshot(api, cfg, io).match((finished) => concludeSnapshot(io, finished), (problem) => failRun(io, problem));
