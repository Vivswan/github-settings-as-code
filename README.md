...
| `interaction_limits` | interaction-limits | Administration: write | untouched | re-arms the self-expiring limit every apply run; `null` clears it; a 409 (org/user-level limit overrides) becomes a note |
