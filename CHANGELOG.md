...
## [3.0.0](https://github.com/Vivswan/github-settings-as-code/compare/v2.0.0...v3.0.0) (2026-09-24)
...
* **actions:** refuse at parse the actions fields that could never converge ([f68d78b](https://github.com/Vivswan/github-settings-as-code/commit/f68d78bf4a26e916499b1bf5d1b6472f6814679a))
...
* **branches:** refuse protection shapes the settings file alone shows wrong ([990c51a](https://github.com/Vivswan/github-settings-as-code/commit/990c51aade3720d9d952b0b0a6e2d8bbc97a0f7e))
* **check-suite-preferences:** refuse app_ids GitHub rejects or collapses when the file is parsed ([5b3c8e9](https://github.com/Vivswan/github-settings-as-code/commit/5b3c8e9475f3a1a1cc61fc2b1d987d546197b1f9))
...
* **ci:** never-throw gate with a shrinking ratchet in lint:arch ([8fcc505](https://github.com/Vivswan/github-settings-as-code/commit/8fcc5055cfaed5a67bfd630bd4e7a5ef8b1a05a4))
...
* **deploy-keys:** refuse anything but a public SSH key at parse ([473aa1a](https://github.com/Vivswan/github-settings-as-code/commit/473aa1a9d103f9a0fd3294c905612fc97c261ff5))
...
* **engine:** a higher layer's null wins and means empty on GitHub, and _remove drops a keyed entry ([2ae92c5](https://github.com/Vivswan/github-settings-as-code/commit/2ae92c5f802ebed687ab4c149375fd7d908c15d7))
* **engine:** a higher-layer null keeps its value on pages and interaction_limits ([6154cc5](https://github.com/Vivswan/github-settings-as-code/commit/6154cc5e03cfbdd58f4d378edc5c0a1ab88cdc8d))
* **engine:** layer environments, branches, and workflows by key through a {_layering, entries} wrapper ([9e52313](https://github.com/Vivswan/github-settings-as-code/commit/9e5231388207222cc72a095bc53a0ae43f044fb7))
* **engine:** layer every list section by key with replace, shallow, and deep ([8133147](https://github.com/Vivswan/github-settings-as-code/commit/81331479f4a2a5c597c1569ac525bc6ba66beecd))
* **engine:** report every parse error of a section in one run ([db7ebec](https://github.com/Vivswan/github-settings-as-code/commit/db7ebec9e5ce45e49c271d6656e4b3fe8df0622f))
* **engine:** resolve the undeclared policy once from a file-wide _undeclared and the undeclared input ([a9dcf68](https://github.com/Vivswan/github-settings-as-code/commit/a9dcf68da10889463927158e972dceb14a7390dd))
* **engine:** run every file-only check before the first write ([1bbe9b2](https://github.com/Vivswan/github-settings-as-code/commit/1bbe9b2db19be6ec7134b926975c35709e9731fd))
* **environments:** declared-off protection converges, and the schema refuses what GitHub never accepts ([aa43d3e](https://github.com/Vivswan/github-settings-as-code/commit/aa43d3eb3c31ec3dc4028fae4fbe1ae9e0945782))
...
* **interaction-limits:** refuse limits, expiries, caps, and keys GitHub rejects when the file is parsed ([1e9a806](https://github.com/Vivswan/github-settings-as-code/commit/1e9a8060ad031657261eca5904f8e0c8a1ff4d26))
* **labels:** refuse colors and descriptions GitHub rejects when the file is parsed ([10242f4](https://github.com/Vivswan/github-settings-as-code/commit/10242f4a0ca0ccbab538d0bc2a0fb4e63fc727a9))
...
* **library:** plan() takes only the input validation minted ([ce31e10](https://github.com/Vivswan/github-settings-as-code/commit/ce31e1025125f1bd42a1885d6942d0ceb9439ce1))
* **pages:** refuse the site fields only the GET reports and a source path Pages cannot publish from ([3f17468](https://github.com/Vivswan/github-settings-as-code/commit/3f17468f150e29d56d82e58a0b6b5ae5c5bffff3))
...
* **release:** publish next from the release-PR hook and drop the post-green verdict ([006e276](https://github.com/Vivswan/github-settings-as-code/commit/006e276774996e4b38ac951af953ecd10eaee993))
...
* **repository:** refuse GET-only keys, illegal commit-message pairs, bad topics, and unknown security sub-keys at parse ([82429e1](https://github.com/Vivswan/github-settings-as-code/commit/82429e118ffc9568d8d38f495e4edcfd7bca214d))
* **rulesets:** refuse what the file alone shows wrong about a ruleset when it is parsed ([50959dd](https://github.com/Vivswan/github-settings-as-code/commit/50959ddca147cfbee9f72e953f4a06ec22393437))
* **secret-scanning:** refuse patterns that cannot compile when the file is parsed ([3c81fa2](https://github.com/Vivswan/github-settings-as-code/commit/3c81fa241e34e3f6fc65a04c2a530ceb08b21dba))
* **secrets:** refuse secret and variable names GitHub rejects when the file is parsed ([6f93110](https://github.com/Vivswan/github-settings-as-code/commit/6f93110b4b1985c6472d6f6cbb87c0df879577ef))
* **sections:** refuse permissions and team names GitHub rejects when the file is parsed ([830d0a8](https://github.com/Vivswan/github-settings-as-code/commit/830d0a87534276f5aa8558aaf4430faf696fbf1b))
* **setup:** refuse known-wrong setup keys at parse and note unechoed keys ([562d6f0](https://github.com/Vivswan/github-settings-as-code/commit/562d6f08357a4029eaf503fcac6dad54b0214a53))
...
* **webhooks:** derive the repository event vocabulary from GitHub's webhooks OpenAPI description ([a3ca9c8](https://github.com/Vivswan/github-settings-as-code/commit/a3ca9c8d324bed75fbc0ea755c4e7ea4e6d79bee))
* **webhooks:** refuse events, content types, insecure_ssl spellings, and urls GitHub would 422 ([4414231](https://github.com/Vivswan/github-settings-as-code/commit/44142310f431464e0dc05e1679f1d1a0afebaf18))
...
* **autolinks:** keep the live is_alphanumeric on a recreate and refuse what GitHub 422s ([#263](https://github.com/Vivswan/github-settings-as-code/issues/263)) ([2011455](https://github.com/Vivswan/github-settings-as-code/commit/2011455dc6d572353d6c7a60199e1b0d1a6714c5))
...
* **branches:** compare actor lists case-insensitively and read an absent review holder as empty ([#269](https://github.com/Vivswan/github-settings-as-code/issues/269)) ([46ed70f](https://github.com/Vivswan/github-settings-as-code/commit/46ed70f329ebe39b23c9d0f99fa78a3f639ae219))
* **branches:** refuse a restrictions block without its users and teams lists at parse ([03f783e](https://github.com/Vivswan/github-settings-as-code/commit/03f783ee5d4ba0b373290ccf64c6b749d150f553))
* **branches:** report an omitted all-empty live restrictions holder and type required_status_checks.checks items ([917025c](https://github.com/Vivswan/github-settings-as-code/commit/917025ce2c42c3a2d60b15a203457e432a16b272))
...
* **engine:** judge secret references at validation, in excluded sections too ([bc0d7f6](https://github.com/Vivswan/github-settings-as-code/commit/bc0d7f6168ce7c850e23e9ba02ed762383f24383))
* **engine:** the validated brand has one mint; the marker injection re-validates ([df18966](https://github.com/Vivswan/github-settings-as-code/commit/df18966034faa435d5724ebcbbe40ab5cb5f1a18))
...
* **layers:** a validation issue after a _remove entry names the entry by its index in the file ([5b4b750](https://github.com/Vivswan/github-settings-as-code/commit/5b4b7508caf7beb34d1a5b3c8c6e77404e54b7b7))
...
* **milestones:** compare due_on by day so it converges ([c02395c](https://github.com/Vivswan/github-settings-as-code/commit/c02395cc90913e140364f8e31de5c7eae2c1bef7))
...
* **sections:** every shape rule reports beside a raw sibling instead of ending on it ([e1c62bd](https://github.com/Vivswan/github-settings-as-code/commit/e1c62bd5d9d394c2a2ec02509f630ef03e9f56ec))
...
* **sections:** note unknown keys on the protection PUT and the routed actions mappings at check time ([56a0809](https://github.com/Vivswan/github-settings-as-code/commit/56a08096254a97287541de1203f70fbb048bed98))
* **sections:** note unknown pages keys at check time and accept Hyperscan start verbs ([899455f](https://github.com/Vivswan/github-settings-as-code/commit/899455f4df273710f600365afd4beee19c4dd55d))
* **sections:** report live values the full-payload write would drop, and refuse to apply over them ([62b27c0](https://github.com/Vivswan/github-settings-as-code/commit/62b27c01fb18e4c9997b2732a265cd852bf68445))
...
* **sections:** undeclared deletes before creates, a lens wire hook for the request body, one boundedString cap helper ([9675999](https://github.com/Vivswan/github-settings-as-code/commit/967599942af3d3a9fe25b6ffcddebc39ac3eb777))
* **settings:** resolve YAML merge keys in the settings reader ([#262](https://github.com/Vivswan/github-settings-as-code/issues/262)) ([8977aea](https://github.com/Vivswan/github-settings-as-code/commit/8977aea70ec26d80f1e355f3cd9a85bf12963ba2))
...
* **github:** the client answers instead of throwing, and the ratchet reaches zero ([d52d4bb](https://github.com/Vivswan/github-settings-as-code/commit/d52d4bbe5dc3daccc5e91637c1e0653ceffc3a05))
...
* **rulesets:** fill target and enforcement at parse so an entry may omit them ([0adf417](https://github.com/Vivswan/github-settings-as-code/commit/0adf417ec136d79c2220a0de8ea49b5351fb3374))
...
* **sections:** section plans return Results instead of throwing ([7ede2bc](https://github.com/Vivswan/github-settings-as-code/commit/7ede2bc73281cf4d4204abeeac78afde2e4ca983))
